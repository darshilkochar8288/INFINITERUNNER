...
function preload(){
 ...
 manimg=loadImage("DEER.png")
  
 lionimg  = loadImage("sprite_0.png");
 backgroundimg=loadImage("HII.jpg");
...
function setup() {
  ...
  man.addImage(manimg);
  man.scale=0.50 ;
  lion=createSprite(100,height-140,10,10);
 ...
 if(keyDown("space")&&man.y >=height-220) {
    ...
    if (gamestate===end){
      ...
      stroke("red");
       strokeWeight(5);
      textSize(40);
  text("THE DEER WAS KILLED BY LION",-5,200 );
    }
